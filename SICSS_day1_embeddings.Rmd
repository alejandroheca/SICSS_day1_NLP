...
BPost_wv <- model1['(Intercept)',] # Biden pre COVID
BPre_wv <- model1['(Intercept)',] + model1['covid_period',] # Biden during COVID 
TPost_wv <- model1['(Intercept)',] + model1['candidate_TRUMP',] # Trump pre COVID
TPre_wv <- model1['(Intercept)',] + model1['candidate_TRUMP',] + model1['covid_period',] # Trump during COVID
